...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--lab1", action="store_true", help="Run main.py from lab1 directory"
    )
    parser.add_argument(
        "--lab2", action="store_true", help="Run main.py from lab2 directory"
    )
    parser.add_argument(
        "--lab3", action="store_true", help="Run main.py from lab3 directory"
    )
    parser.add_argument(
        "--lab4", action="store_true", help="Run main.py from lab4 directory"
    )
